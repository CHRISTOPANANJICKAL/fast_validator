...
class FastMinValueValidation implements FastValidation {
  ...
  validate<T>(T dataToValidate, String? fieldName) {
    ...
    if ((dataToValidate.runtimeType != int && dataToValidate.runtimeType != double) ||
      ...
      errorMessage = customMessage ?? '${fieldName ?? 'this field'} must be greater than or equal to $minValue';
      valid = false;
      outputType = ResultType.invalid;
    }
...
class FastMaxValueValidation implements FastValidation {
  ...
  validate<T>(T dataToValidate, String? fieldName) {
    ...
    if ((dataToValidate.runtimeType != int && dataToValidate.runtimeType != double) ||
      ...
      errorMessage = customMessage ?? '${fieldName ?? 'this field'} must be less than or equal to $maxValue';
      valid = false;
      outputType = ResultType.invalid;
    }
