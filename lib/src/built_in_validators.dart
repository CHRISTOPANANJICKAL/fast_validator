...
class FastMinValueValidation implements FastValidation {
  ...
  validate<T>(T dataToValidate, String? fieldName) {
    ...
    if ((dataToValidate.runtimeType != int &&
      ...
      errorMessage = customMessage ??
          '${fieldName ?? 'this field'} must be greater than or equal to $minValue';
      valid = false;
      outputType = ResultType.invalid;
    }
...
class FastMaxValueValidation implements FastValidation {
  ...
  validate<T>(T dataToValidate, String? fieldName) {
    ...
    if ((dataToValidate.runtimeType != int &&
      ...
      errorMessage = customMessage ??
          '${fieldName ?? 'this field'} must be less than or equal to $maxValue';
      valid = false;
      outputType = ResultType.invalid;
    }
...
class FastDateValidation implements FastValidation {
  ...
  String? _checkEqualValidation(DateTime date, String? fieldName) {
    ...
    return equalsError ??
        '${fieldName ?? 'this field'} must be equal to ${errorStringDate ?? 'the given date'}';
  }
  ...
  String? _checkMinDateValidation(DateTime date, String? fieldName) {
    ...
    return minError ??
        '${fieldName ?? 'this field'} must be a date after ${errorStringDate ?? 'the given date'}';
  }
  ...
  String? _checkMaxDateValidation(DateTime date, String? fieldName) {
    ...
    return maxError ??
        '${fieldName ?? 'this field'} must be a date before ${errorStringDate ?? 'the given date'}';
  }
}
...
bool _isLengthAvailable(dynamic a) => (a is String || a is List || a is Map);
